                ...
                <div class="row clearfix">
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      ...
                      <h3>
                        Prediction Strike is a new take on sports investing: a stock market for professional athletes.
                      </h3>
                      <a style={{textDecoration: "none"}} href="https://www.predictionstrike.com/" class="btn-style-one theme-btn">
                        Explore WebAPP
                      </a>

                      <a style={{textDecoration: "none", marginLeft: "10px"}} href="https://play.google.com/store/apps/details?id=com.predictionstrike&pli=1" class="btn-style-one theme-btn">
                        Explore MobileAPP
                      </a>
                    </div>
                  </div>
            ...
            <div class="case-block-three">
              <div class="inner-box">
                <div class="row clearfix">
                  ...
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      <div class="title"><img src={case2} alt="hard-Assets" /> </div>
                      <h3>
                        CompleteOR is Digital Medical’s platform that streamlines inventory management and tracking of hospital equipment. 
                      </h3>
                      <a href="https://hardassetsalliance.com/" class="btn-style-one theme-btn" style={{textDecoration: "none", marginRight: "10px"}}>
                        Explore WebApp
                      </a>
                      <a href="https://play.google.com/store/apps/details?id=com.haamobileapplication" class="btn-style-one theme-btn" style={{textDecoration: "none"}}>
                        Explore MobileAPP
                      </a>
                    </div>
                  </div>
            ...
            <div class="case-block-three">
              <div class="inner-box">
                <div class="row clearfix">
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      <div class="title"><img src={case3Logo} /></div>
                      <h3>
                        <a href="#" style={{textDecoration: "none"}}>
                        Distro Pro is a nexus where high-end studio design, acoustic treatment and isolation, custom monitor systems.
                        </a>
                      </h3>
                      <a href="https://distroproaudio.com/" class="btn-style-one theme-btn" style={{textDecoration: "none"}}>
                        Explore WebAPP
                      </a>
                    </div>
                  </div>
              ...
              <div class="inner-box">
                <div class="row clearfix">
                  ...
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      <div class="title">
                      <svg xmlns="http://www.w3.org/2000/svg" width="50" id="Lag_1" data-name="Lag 1" viewBox="0 0 105.14 119.69"><defs></defs><path class="cls-1" d="M228.18,358.22c3.54,1.85,7,3.89,10.43,5.87,4,2.32,8.13,4.51,12.17,6.8q5.53,3.14,11,6.38a2.36,2.36,0,0,0,2.84,0c2.14-1.37,4.39-2.59,6.76-4l-7.78-4.6q-10.06-5.91-20.14-11.82-7.22-4.25-14.4-8.53l-.91-.52q0-19.15,0-38.32a2.89,2.89,0,0,1,1.19-2.75c2.19-1.37,4.36-2.76,6.57-4.1,1-.6.9.17.9.8v36.91c0,.36,0,.72,0,1.07,0,3.72-.32,2.68,2.55,4.32,4.29,2.33,8.5,4.82,12.75,7.25,4.54,2.59,9.08,5.17,13.61,7.79s9,5.27,13.55,7.91a1,1,0,0,0,1.21,0l12.72-7.48c7.09-4.18,14.17-8.38,21.27-12.54,6-3.53,12.09-7,18.14-10.53a1.29,1.29,0,0,0,.16-.17c.57.08.51.52.51.91,0,3,0,6,0,9a2,2,0,
74-2.69,9.47-5.42,14.21-8.12a1.19,1.19,0,0,1,.47-.07c0,2.89,0,5.78.06,8.66a1.79,1.79,0,0,1-.53,1.15c-2.74,1.53-5.48,3.05-8.21,4.6q-6.39,3.66-12.76,7.34l-3.46,2c-.89.55-1.81,1.06-2.69,1.62-3.55,1.84-7.07,3.76-10.52,5.79Q288.75,393,282.38,396.75Z" transform="translate(-228.14 -277.41)"></path><path class="cls-1" d="M314.72,368.48" transform="translate(-228.14 -277.41)"></path></svg>
                      Coachr
                      </div>
                      <h3>
                        Our platform is built for speed. Replace messy excel-sheets and repetitive tasks with an intelligent workflow.
                      </h3>
                      <a href="https://www.coachr.io/" class="btn-style-one theme-btn" style={{textDecoration: "none"}}>
                        Explore WebAPP
                      </a>
                    </div>
                  </div>
            ...
            <div class="case-block-three">
              <div class="inner-box">
                <div class="row clearfix">
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      <div class="title"><img src={case5Logo} /></div>
                      <h3>
                        The Proctor Gallagher Institute is dedicated to waking the world up so more people can reach their potential through shifting paradigms.
                      </h3>
                      <a href="https://www.proctorgallagherinstitute.com/" class="btn-style-one theme-btn" style={{textDecoration: "none"}}>
                        Explore WebAPP
                      </a>
                    </div>
                  </div>
                ...
                <div class="row clearfix">
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      ...
                      <a href="https://get.fitr.training/" class="btn-style-one theme-btn" style={{textDecoration: "none", marginRight: "10px"}}>
                        Explore WebAPP
                      </a>
                      <a href="https://play.google.com/store/apps/details?id=com.fitr_training.client" class="btn-style-one theme-btn" style={{textDecoration: "none"}}>
                        Explore MobileAPP
                      </a>
                    </div>
                  </div>
                ...
                <div class="row clearfix">
                  ...
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      ...
                      <a href="https://www.taskrabbit.com/" class="btn-style-one theme-btn" style={{textDecoration: "none", marginRight: "10px"}}>
                        Explore WebAPP
                      </a>
                      <a href="https://play.google.com/store/apps/details?id=com.taskrabbit.droid.consumer&utm_source=website&utm_medium=button&utm_campaign=app-android" class="btn-style-one theme-btn" style={{textDecoration: "none"}}>
                        Explore MobileAPP
                      </a>
                    </div>
                  </div>
            ...
            <div class="case-block-three">
              <div class="inner-box">
                <div class="row clearfix">
                  <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="content">
                      <div class="title"><img src={case9Logo} style={{height: "90px"}} /></div>
                      <h3>
                      Enabling Fast, Accurate & Reliable COVID-19 Testing Across The Globe
                      </h3>
                      <br/>
                      <a href="https://circlepod.co/en-hk/" class="btn-style-one theme-btn" style={{textDecoration: "none", marginRight: "10px"}}>
                        Explore WebAPP
                      </a>
                      <a href="https://circlepod.co/en-hk/https://play.google.com/store/apps/details?id=com.prenetics.circle.pod" class="btn-style-one theme-btn" style={{textDecoration: "none"}}>
                        Explore MobileAPP
                      </a>
                    </div>
                  </div>
